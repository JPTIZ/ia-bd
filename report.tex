...
\begin{document}
    ...
    \begin{questions}
        ...
        \begin{answer}
            ...
            indecidível~\cite{tsarkov:2003} --- corroborado pela decisão de
            restringir a no máximo duas variáveis consideradas
            em~\cite{frank:2001} ---, e consequência significa que a DL de OWL
            2 permite descrever problemas indecidíveis.
            ...
            Não conseguimos, porém, encontrar um exemplo claro do que não é
            possível fazer com DL e que seja com FOL\@. Toda documentação
            descreve que DLs são fragmentos de FOL, mas nenhuma indica em que
            ponto elas se dividem.
        \end{answer}
    \end{questions}
