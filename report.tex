...
\begin{document}
    ...
    \begin{questions}
        ...
        \begin{answer}
            ...
            Equação~\ref{transitive-fol}) e portanto
            indecidível~\cite{tsarkov:2003}, o que por consequência significa
            que a DL de OWL 2 permite descrever problemas indecidíveis.
